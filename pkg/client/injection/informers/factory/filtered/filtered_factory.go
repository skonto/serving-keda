...
import (
	...
	externalversions "github.com/skonto/serving-keda/pkg/client/informers/externalversions"
	client "github.com/skonto/serving-keda/pkg/client/injection/client"
...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/skonto/serving-keda/pkg/client/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}
